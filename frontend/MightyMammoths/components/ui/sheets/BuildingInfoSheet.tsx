...
export type BuildingInfoSheetProps = ActionSheetProps & {
  ...
  navigate: () => void;
  navigateIndoor: (buildingName: string) => void;
  onClose: () => void;
};
    ...
    >
      <View style={styles.container}>
        <Text style={styles.header}>
          {building?.properties["Building Long Name"]}
        </Text>
        <View style={styles.buttonsContainer}>
          <View style={[styles.button, styles.destinationButton]}>
          ...
          <View style={[styles.button, styles.indoorMapButton]}>
            <Pressable
              onPress={() => navigateIndoor(building.properties.BuildingName)}
            >
