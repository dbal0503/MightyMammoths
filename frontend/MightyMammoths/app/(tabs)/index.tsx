...
import { getIndoorMapUrl } from "@/services/indoorMapLinker";
...
export default function HomeScreen() {
  ...
  const switchToIndoor = (buildingName: string) => {
    placeInfoSheet.current?.hide();
    campusToggleSheet.current?.hide();
    // setIndoorMapVisible(true); taking this out for now to show this alternate method
    const url = getIndoorMapUrl(buildingName);
    if (url === "No link available") {
      Alert.alert("No indoor map available for this building yet");
      return;
    }
    Linking.openURL(url);
  };
